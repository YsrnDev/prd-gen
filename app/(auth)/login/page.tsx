        ...
        <div className="animate-fade-in">
            ...
            <div className="text-center mb-8">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-4">
                    <Image src="/logo.webp" alt="Lucky Brew" width={56} height={56} className="object-contain rounded-md" />
                </div>
                <h1 className="text-2xl font-bold text-white">Welcome back</h1>
                <p className="text-sm text-slate-400 mt-1">Sign in to your Lucky Brew account</p>
            </div>
            ...
            <div className="glass-card p-8">
                ...
                <div className="relative mb-6">
                    ...
                    <div className="relative flex justify-center text-xs">
                        <span className="px-3 bg-[var(--color-card)] text-slate-400">or continue with email</span>
                    </div>
                </div>
