...
export default function LandingNavbar() {
    ...
    return (
        <header data-anim="navbar" className="whitespace-nowrap border-b border-solid border-slate-800/50 py-4 bg-[#0f172a]/80 backdrop-blur-md fixed top-0 left-0 right-0 z-50">
