...
def check_page(file_path: Path) -> dict:
    ...
    # Detect if this is a root layout/template file that MUST have SEO tags
    is_root_file = file_path.name.lower() in ['layout.tsx', 'layout.jsx', '_app.tsx', '_document.tsx'] and len(file_path.parts) <= 3
    is_home_page = file_path.name.lower() in ['page.tsx', 'page.jsx', 'index.tsx', 'index.jsx'] and len(file_path.parts) <= 3
    
    is_layout = is_root_file or is_home_page
